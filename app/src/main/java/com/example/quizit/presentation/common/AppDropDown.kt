        ...
        ExposedDropdownMenuBox(expanded = isExpanded, onExpandedChange ={isExpanded=!isExpanded} ) {
            OutlinedTextField(
                ...
                colors=TextFieldDefaults.outlinedTextFieldColors(
                    focusedTextColor = colorResource(id = R.color.uppertext),
                    unfocusedTextColor = colorResource(id = R.color.uppertext),
            ...
            DropdownMenu(
                ...
                menuList.forEachIndexed { index:Int,text: String ->
                    DropdownMenuItem(text = { Text(text=text,color= colorResource(id = R.color.uppertext)) }
                        , onClick = {
